"""Automated REPL command tests for Keysight DSOX1204G oscilloscope."""
...
from lab_instruments.mock_instruments import MockDSOX1204G
...
class TestKeysightMeasurements:
...
# --- Display (skip grid/gridbright -- not on Keysight 1000X) ---


class TestKeysightDisplay:
...
# --- Acquire (skip depth -- not on Keysight 1000X) ---


class TestKeysightAcquire:
...
# --- Cursor (now supported on Keysight) ---


class TestKeysightCursor:
...
# --- Math (skip filter -- not on Keysight 1000X) ---


class TestKeysightMath:
...
# --- Built-in tools (counter, DVM, AWG) ---


class TestKeysightTools:
