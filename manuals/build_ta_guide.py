"""Build the TA Developer Guide DOCX from markdown chapter files.

Usage:
    python manuals/build_ta_guide.py

Generates: manuals/ta-developer-guide.docx
"""
...
SOURCE_DIR = MANUAL_DIR / "ta-developer"
OUTPUT = MANUAL_DIR / "ta-developer-guide.docx"

# Chapter files in order
CHAPTERS = [
    "ch01_architecture.md",
    "ch02_dev_setup.md",
    "ch03_adding_driver.md",
    "ch04_adding_repl_commands.md",
    "ch05_adding_examples.md",
    "ch06_driver_contract.md",
    "ch07_writing_tests.md",
    "ch08_ci_debugging.md",
...
def parse_markdown(doc, md_text, base_dir=None):
    ...
    while i < len(lines):
        ...
        # Headings: any level 1-6. Without this any "#### ..." line fell
        # through all three checks and the paragraph collector below
        # `break`ed on it without advancing i, causing an infinite loop.
...
def build():
    ...
    run = subtitle.add_run("TA Developer Guide")
    run.font.size = Pt(20)
    run.font.color.rgb = RGBColor(0x50, 0x0, 0x0)
